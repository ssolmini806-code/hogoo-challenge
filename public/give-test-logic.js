...
const typeCatalog = window.GIVE_TYPE_CATALOG?.types;
const sharedAxisDefinitions = window.GIVE_TYPE_CATALOG?.axes;
if (!typeCatalog || !sharedAxisDefinitions) {
    throw new Error("GIVE 유형 카탈로그를 불러오지 못했습니다.");
}
...
const axisDefinitions = sharedAxisDefinitions;
